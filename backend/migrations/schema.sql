...
-- ---------------------------------------------------------------------------
-- Obit Market + Obit SafePay (pilot)
-- Customer funds are never represented as an Obit-held wallet balance.
-- Provider escrow IDs reference funds held by the regulated third-party partner.
-- ---------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS market_orders (
  ...
  currency            TEXT NOT NULL DEFAULT 'NGN',
  provider            TEXT,
  provider_escrow_id  TEXT UNIQUE,
  status              TEXT NOT NULL DEFAULT 'CREATED' CHECK (status IN (
    'CREATED','AWAITING_FUNDING','FUNDED','DELIVERING','DELIVERED',
    'DELIVERY_CONFIRMED','DISPUTED','RELEASE_PENDING','RELEASED',
...
CREATE TABLE IF NOT EXISTS market_disputes (
  ...
  opened_by_member_id   INTEGER NOT NULL REFERENCES members(id),
...
CREATE TABLE IF NOT EXISTS safepay_events (
  ...
  provider       TEXT NOT NULL,
  event_id       TEXT NOT NULL,
  order_id       INTEGER REFERENCES market_orders(id),
