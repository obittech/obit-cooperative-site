...
const tables = ['users','member_applications','consents','kyc_checks','membership_payments','members','community_onboarding','contribution_plans','payment_identities','ledger_accounts','transactions','ledger_entries','member_bank_accounts','withdrawal_requests','receipts','webhook_events','referrals','audit_events','opportunities','communities','market_listings','market_orders','market_disputes','safepay_events'];
